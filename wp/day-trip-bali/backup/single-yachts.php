    ...
    <div class="white-block">
      <div data-move="tour-header__tour-content,1,1140" class="container white-block__container full-size">
        <div class="white-block__items">
          <?php
                    $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                    foreach ($terms as $term):
                      $args = ['post_type' => 'info', 'posts_per_page' => 3, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
            ...
            <div class="details-section__left">
              <div class="details-section__items">
                <?php
                    $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                    foreach ($terms as $term):
                      $args = ['post_type' => 'tour_program', 'posts_per_page' => 105, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
                      $posts_with_term = new WP_Query($args);
                      while ($posts_with_term->have_posts()):
                          $posts_with_term->the_post(); ?>
              ...
              <div class="swiper-container">
                ...
                <div class="swiper-wrapper">
                  ...
                  <?php
                    $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                    foreach ($terms as $term):
                      $args = ['post_type' => 'gallery_tours', 'posts_per_page' => 105, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
                      $posts_with_term = new WP_Query($args);
                      while ($posts_with_term->have_posts()):
                          $posts_with_term->the_post(); ?>
        ...
        <div class="container section__container list-section__container full-size">
          <div class="list-section__left">
            ...
            <div class="list-section__left-items">
              <?php
                    $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                    foreach ($terms as $term):
                      $args = ['post_type' => 'price_tours', 'posts_per_page' => 20, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
                      $posts_with_term = new WP_Query($args);
                      while ($posts_with_term->have_posts()):
                          $posts_with_term->the_post(); ?>
          ...
          <div class="list-section__right">
            ...
            <div class="list-section__right-items">
              ...
              $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                foreach ($terms as $term):
                  $args = ['post_type' => 'additional_service', 'posts_per_page' => 105, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
                    $posts_with_term = new WP_Query($args);
                      while ($posts_with_term->have_posts()):
                          $posts_with_term->the_post(); ?>
          ...
          <div class="bottom-content bottom-content__marign">
            <div class="tours-preview-wrapper" style="opacity: 0">
              <?php
                  $terms = get_terms(['taxonomy' => 'yachat_tax', 'name' => get_the_title() , 'pad_counts' => 1, 'parent' => 0, 'hide_empty' => false, 'post_per_page' => 125 ]);
                    foreach ($terms as $term):
                      $args = ['post_type' => 'tours', 'posts_per_page' => 20, 'orderby' => 'id', 'order' => 'ASC', 'tax_query' => [['taxonomy' => 'yachat_tax', 'field' => 'term_id', 'terms' => $term->term_id, 'include_children' => false, ], ], ];
                      $posts_with_term = new WP_Query($args);
                      while ($posts_with_term->have_posts()):
                          $posts_with_term->the_post(); ?>
