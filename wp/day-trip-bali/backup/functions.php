...
function icons($val)
{
	if ($val === 'calendar-icon') {
		return '/img/tour-icons/days.svg';
	} elseif ($val === 'clock-icon') {
		return '/img/tour-icons/time.svg';
	} elseif ($val === 'price-icon') {
		return '/img/tour-icons/price.svg';
	}
}
