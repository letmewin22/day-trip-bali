  ...
  <div class="container section__container footer__container full-size">
    <div class="footer__cols-wrapper">
      <div class="footer__col-1">
        ...
        <a target='_blank' rel='noreferer noopener' href="https://wa.me/<?php echo preg_replace('/\D+/', '', get_option('theme_contact_tel1'));?>?text=Hi!%20I%20want%20to%20have%20more%20info%20about%20boat%20advenutre%20"><?php echo get_option('theme_contact_tel1');?> (WhatsAppp)</a>
