import { Expo, Power2, TimelineMax } from 'gsap'
...
export const loading = () => {
  ...
  setTimeout(() => {
    ...
    h1Desc && tl2.to(h1Desc, 1.5, { opacity: 1, x: 0, ease: Expo.easeOut }, 0)
    video && tl2.to(video, 1.2, { opacity: 1, ease: Power2.easeOut }, 0.2)
    infoBlock &&
      tl2.to(infoBlock, 1.2, { opacity: 1, y: 0, ease: Power2.easeOut }, 0.7)
  }, 500)
}
